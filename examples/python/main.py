"""
Example: How to call the bing-ads-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/bing-ads-scraper
...
def run_actor():
    """Run the bing-ads-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/bing-ads-scraper"
